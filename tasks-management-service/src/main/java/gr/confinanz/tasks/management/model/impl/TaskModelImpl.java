...
import gr.confinanz.tasks.management.model.TaskModel;
import gr.confinanz.tasks.management.model.TaskSoap;
...
/**
 * The base model implementation for the Task service. Represents a row in the &quot;ABT_Task&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TaskModelImpl extends BaseModelImpl<Task> implements TaskModel {
	 ...
	 */
	public static final String TABLE_NAME = "ABT_Task";
	...
	public static final String TABLE_SQL_CREATE = "create table ABT_Task (uuid_ VARCHAR(75) null,taskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(75) null,description VARCHAR(75) null,expirationDate DATE null,taskUserId LONG,completed BOOLEAN,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table ABT_Task";
	public static final String ORDER_BY_JPQL = " ORDER BY task.expirationDate ASC, task.title ASC";
	public static final String ORDER_BY_SQL = " ORDER BY ABT_Task.expirationDate ASC, ABT_Task.title ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(gr.confinanz.tasks.management.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.gr.confinanz.tasks.management.model.Task"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(gr.confinanz.tasks.management.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.gr.confinanz.tasks.management.model.Task"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(gr.confinanz.tasks.management.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.gr.confinanz.tasks.management.model.Task"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(gr.confinanz.tasks.management.service.util.ServiceProps.get(
				"lock.expiration.time.gr.confinanz.tasks.management.model.Task"));
	...
	public String toXmlString() {
		...
		sb.append("gr.confinanz.tasks.management.model.Task");
